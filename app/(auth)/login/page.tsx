...
export default function LoginPage() {
  ...
  // Read success message from query param set by reset-password page.
  // Using window.location.search (not useSearchParams) to avoid needing a
  // Suspense boundary around this client component.
  useEffect(() => {
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="password" className="block text-small font-medium text-ink-85">
                  Password
                </label>
                <Link
